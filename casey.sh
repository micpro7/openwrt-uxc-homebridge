...
# ==============================================================================
GITHUB_USER="micpro7"
GITHUB_REPO="openwrt-uxc-homebridge"
GITHUB_ASSET="homebridge-arm64.tar.gz"

# Derived URL Construction
BUNDLE_URL="https://github.com/$GITHUB_USER/$GITHUB_REPO/releases/latest/download/$GITHUB_ASSET"
...
# ==============================================================================
TIMEZONE="Europe/Amsterdam"                   # Local system timezone
...
# ==========================================
echo "📥 [Phase 4] Pulling production blueprint package from GitHub ($GITHUB_USER/$GITHUB_REPO)..."

if ! wget -q --show-progress -O "$ARCHIVE" "$BUNDLE_URL"; then
    echo "❌ Error: Failed to download Homebridge bundle from $BUNDLE_URL" >&2
    exit 1
fi
...
# ==============================================================================
# STOP FUNCTION
# Tini handles SIGTERM propagation and child process shutdown natively.
# ==============================================================================
stop() {
